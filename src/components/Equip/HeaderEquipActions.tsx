...
import { PresetButtonsEquip } from "./PresetButtonsEquip";
...
export function EquipHeaderActions({ sheetName, setSheetName, onSave, onOpenSaved }: EquipHeaderActionsProps) {
  const baseClasses = "fixed z-[9999] p-5 max-w-[1200px] mx-auto rounded-[10px] border-4 shadow-dark-blue flex flex-col gap-5 w-full bg-bgpagelight border-primary "
  return (
