...
//                 >
//                   <img src="/assets/images/system/clean-stone.png" width={32} height={11} className="mx-auto" />
//                 </button>
//               </>
//             )}
...
//               >
//                 <img src="/assets/images/system/arrow_cropped.png" width={32} height={11} className="mx-auto" />
//               </button>
//             )}
...
//         <CardModal onClose={() => setCardModal(null)} rarity={equippedItem.grade || "rare"} slotName={equippedItem.type} />
//       )}
...
export function Items({ name, equipmentType }: SlotProps) {
  const { addSource, removeSource, clearSourcesByPrefix } = useAtkTotal();
  const { equipped, equipItem, unequipItem, equipProps, equipStone, unequipStone } = useEquip();
  const equippedItem = equipped[name];
